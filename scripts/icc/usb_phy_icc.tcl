# Auto-generated ICC2 script for usb_phy
# Configuration: usb_phy
...
set lib_name "usb_phy"
set mw_logic0_net VSS
set mw_logic1_net VDD
set design_data ./outputs/usb_phy/usb_phy.ddc
set cell_name "usb_phy"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/usb_phy/$lib_name.mw \
...
open_mw_lib ./outputs/usb_phy/$lib_name.mw
read_verilog ./outputs/usb_phy/usb_phy.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/usb_phy/usb_phy.sdc
...
write_parasitics -output ./outputs/usb_phy_extracted.spef -format SPEF
write_sdf ./outputs/usb_phy_extracted.sdf
write_sdc ./outputs/usb_phy_extracted.sdc
write_verilog ./outputs/usb_phy_extracted.v

report_constraints -all > ./reports/usb_phy/icc_usb_phy_constraints.rpt
report_area > ./reports/usb_phy/icc_usb_phy_area.rpt
report_power > ./reports/usb_phy/icc_usb_phy_power.rpt
report_qor  > ./reports/usb_phy/icc_usb_phy_qor.rpt
report_cell > ./reports/usb_phy/icc_usb_phy_cells.rpt
report_resources > ./reports/usb_phy/icc_usb_phy_resources.rpt
report_timing -max_paths 10 > ./reports/usb_phy/icc_usb_phy_timing.rpt

save_mw_cel -as usb_phy_extracted
quit
