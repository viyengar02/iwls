...
report_port > ./reports/ac97_ctrl/icc_ac97_top_ports.rpt
sizeof_collection [get_ports [all_inputs]] >> ./reports/ac97_ctrl/icc_ac97_top_ports.rpt
sizeof_collection [get_ports [all_outputs]] >> ./reports/ac97_ctrl/icc_ac97_top_ports.rpt
# can also generate histograms
report_clock_tree -summary > ./reports/ac97_ctrl/icc_ac97_top_clock_tree.rpt
sizeof_collection [get_cells -filter "ref_name=~*INV*" -clock_tree] >> ./reports/ac97_ctrl/icc_ac97_top_clock_tree.rpt
