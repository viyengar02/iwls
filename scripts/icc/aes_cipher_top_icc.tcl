# Auto-generated ICC2 script for aes_cipher_top
# Configuration: aes_core
...
set lib_name "aes_cipher_top"
set mw_logic0_net VSS
set mw_logic1_net VDD
set design_data ./outputs/aes_core/aes_cipher_top.ddc
set cell_name "aes_cipher_top"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/aes_core/$lib_name.mw \
...
open_mw_lib ./outputs/aes_core/$lib_name.mw
read_verilog ./outputs/aes_core/aes_cipher_top.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/aes_core/aes_cipher_top.sdc
...
write_parasitics -output ./outputs/aes_cipher_top_extracted.spef -format SPEF
write_sdf ./outputs/aes_cipher_top_extracted.sdf
write_sdc ./outputs/aes_cipher_top_extracted.sdc
write_verilog ./outputs/aes_cipher_top_extracted.v

report_constraints -all > ./reports/aes_core/icc_aes_cipher_top_constraints.rpt
report_area > ./reports/aes_core/icc_aes_cipher_top_area.rpt
report_power > ./reports/aes_core/icc_aes_cipher_top_power.rpt
report_qor  > ./reports/aes_core/icc_aes_cipher_top_qor.rpt
report_cell > ./reports/aes_core/icc_aes_cipher_top_cells.rpt
report_resources > ./reports/aes_core/icc_aes_cipher_top_resources.rpt
report_timing -max_paths 10 > ./reports/aes_core/icc_aes_cipher_top_timing.rpt
report_placement_utilization > ./reports/aes_core/icc_aes_cipher_top_cts.rpt
report_port > ./reports/aes_core/icc_aes_cipher_top_ports.rpt
sizeof_collection [get_ports [all_inputs]] >> ./reports/aes_core/icc_aes_cipher_top_ports.rpt
sizeof_collection [get_ports [all_outputs]] >> ./reports/aes_core/icc_aes_cipher_top_ports.rpt
# can also generate histograms
report_clock_tree -summary > ./reports/aes_core/icc_aes_cipher_top_clock_tree.rpt
sizeof_collection [get_cells -filter "ref_name=~*INV*" -clock_tree] >> ./reports/aes_core/icc_aes_cipher_top_clock_tree.rpt


save_mw_cel -as aes_cipher_top_extracted
quit
