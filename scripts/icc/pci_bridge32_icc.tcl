# Auto-generated ICC2 script for pci_bridge32
# Configuration: pci
...
set lib_name "pci_bridge32"
set mw_logic0_net VSS
set mw_logic1_net VDD
set design_data ./outputs/pci/pci_bridge32.ddc
set cell_name "pci_bridge32"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/pci/$lib_name.mw \
...
open_mw_lib ./outputs/pci/$lib_name.mw
read_verilog ./outputs/pci/pci_bridge32.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/pci/pci_bridge32.sdc
...
write_parasitics -output ./outputs/pci_bridge32_extracted.spef -format SPEF
write_sdf ./outputs/pci_bridge32_extracted.sdf
write_sdc ./outputs/pci_bridge32_extracted.sdc
write_verilog ./outputs/pci_bridge32_extracted.v

report_constraints -all > ./reports/pci/icc_pci_bridge32_constraints.rpt
report_area > ./reports/pci/icc_pci_bridge32_area.rpt
report_power > ./reports/pci/icc_pci_bridge32_power.rpt
report_qor  > ./reports/pci/icc_pci_bridge32_qor.rpt
report_cell > ./reports/pci/icc_pci_bridge32_cells.rpt
report_resources > ./reports/pci/icc_pci_bridge32_resources.rpt
report_timing -max_paths 10 > ./reports/pci/icc_pci_bridge32_timing.rpt

save_mw_cel -as pci_bridge32_extracted
quit
