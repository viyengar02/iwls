# Auto-generated ICC2 script for des3_area
# Configuration: des3_area
...
set lib_name "des3_area"
set mw_logic0_net VSS
set mw_logic1_net VDD
set design_data ./outputs/des3_area/des3_area.ddc
set cell_name "des3_area"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/des3_area/$lib_name.mw \
...
open_mw_lib ./outputs/des3_area/$lib_name.mw
read_verilog ./outputs/des3_area/des3_area.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/des3_area/des3_area.sdc
...
write_parasitics -output ./outputs/des3_area_extracted.spef -format SPEF
write_sdf ./outputs/des3_area_extracted.sdf
write_sdc ./outputs/des3_area_extracted.sdc
write_verilog ./outputs/des3_area_extracted.v

report_constraints -all > ./reports/des3_area/icc_des3_area_constraints.rpt
report_area > ./reports/des3_area/icc_des3_area_area.rpt
report_power > ./reports/des3_area/icc_des3_area_power.rpt
report_qor  > ./reports/des3_area/icc_des3_area_qor.rpt
...
report_port > ./reports/des3_area/icc_des3_area_ports.rpt
sizeof_collection [get_ports [all_inputs]] >> ./reports/des3_area/icc_des3_area_ports.rpt
sizeof_collection [get_ports [all_outputs]] >> ./reports/des3_area/icc_des3_area_ports.rpt
# can also generate histograms
report_clock_tree -summary > ./reports/des3_area/icc_des3_area_clock_tree.rpt
sizeof_collection [get_cells -filter "ref_name=~*INV*" -clock_tree] >> ./reports/des3_area/icc_des3_area_clock_tree.rpt
