# Auto-generated ICC2 script for des
# Configuration: systemcdes
...
set design_data ./outputs/systemcdes/des.ddc
set cell_name "des"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/systemcdes/$lib_name.mw \
...
open_mw_lib ./outputs/systemcdes/$lib_name.mw
read_verilog ./outputs/systemcdes/des.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/systemcdes/des.sdc
...
write_parasitics -output ./outputs/des_extracted.spef -format SPEF
write_sdf ./outputs/des_extracted.sdf
write_sdc ./outputs/des_extracted.sdc
write_verilog ./outputs/des_extracted.v

report_constraints -all > ./reports/systemcdes/icc_des_constraints.rpt
report_area > ./reports/systemcdes/icc_des_area.rpt
report_power > ./reports/systemcdes/icc_des_power.rpt
report_qor  > ./reports/systemcdes/icc_des_qor.rpt
report_cell > ./reports/systemcdes/icc_des_cells.rpt
report_resources > ./reports/systemcdes/icc_des_resources.rpt
report_timing -max_paths 10 > ./reports/systemcdes/icc_des_timing.rpt

save_mw_cel -as des_extracted
quit
