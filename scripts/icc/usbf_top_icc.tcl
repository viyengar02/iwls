# Auto-generated ICC2 script for usbf_top
# Configuration: usb_funct
...
set lib_name "usbf_top"
set mw_logic0_net VSS
set mw_logic1_net VDD
set design_data ./outputs/usb_funct/usbf_top.ddc
set cell_name "usbf_top"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/usb_funct/$lib_name.mw \
...
open_mw_lib ./outputs/usb_funct/$lib_name.mw
read_verilog ./outputs/usb_funct/usbf_top.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/usb_funct/usbf_top.sdc
...
write_parasitics -output ./outputs/usbf_top_extracted.spef -format SPEF
write_sdf ./outputs/usbf_top_extracted.sdf
write_sdc ./outputs/usbf_top_extracted.sdc
write_verilog ./outputs/usbf_top_extracted.v

report_constraints -all > ./reports/usb_funct/icc_usbf_top_constraints.rpt
report_area > ./reports/usb_funct/icc_usbf_top_area.rpt
report_power > ./reports/usb_funct/icc_usbf_top_power.rpt
report_qor  > ./reports/usb_funct/icc_usbf_top_qor.rpt
report_cell > ./reports/usb_funct/icc_usbf_top_cells.rpt
report_resources > ./reports/usb_funct/icc_usbf_top_resources.rpt
report_timing -max_paths 10 > ./reports/usb_funct/icc_usbf_top_timing.rpt

save_mw_cel -as usbf_top_extracted
quit
