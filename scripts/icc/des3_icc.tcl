# Auto-generated ICC2 script for des3
...
set design_data ./outputs/des3_area/des3.ddc
set cell_name "des3"
...
read_verilog ./outputs/des3_area/des3.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/des3_area/des3.sdc
...
write_parasitics -output ./outputs/des3_extracted.spef -format SPEF
write_sdf ./outputs/des3_extracted.sdf
write_sdc ./outputs/des3_extracted.sdc
write_verilog ./outputs/des3_extracted.v

report_constraints -all > ./reports/des3_area/icc_des3_constraints.rpt
report_area > ./reports/des3_area/icc_des3_area.rpt
report_power > ./reports/des3_area/icc_des3_power.rpt
report_qor  > ./reports/des3_area/icc_des3_qor.rpt
report_cell > ./reports/des3_area/icc_des3_cells.rpt
report_resources > ./reports/des3_area/icc_des3_resources.rpt
report_timing -max_paths 10 > ./reports/des3_area/icc_des3_timing.rpt

save_mw_cel -as des3_extracted
quit
