# Auto-generated ICC2 script for wb_dma_top
# Configuration: wb_dma
...
set lib_name "wb_dma_top"
set mw_logic0_net VSS
set mw_logic1_net VDD
set design_data ./outputs/wb_dma/wb_dma_top.ddc
set cell_name "wb_dma_top"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/wb_dma/$lib_name.mw \
...
open_mw_lib ./outputs/wb_dma/$lib_name.mw
read_verilog ./outputs/wb_dma/wb_dma_top.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/wb_dma/wb_dma_top.sdc
...
write_parasitics -output ./outputs/wb_dma_top_extracted.spef -format SPEF
write_sdf ./outputs/wb_dma_top_extracted.sdf
write_sdc ./outputs/wb_dma_top_extracted.sdc
write_verilog ./outputs/wb_dma_top_extracted.v

report_constraints -all > ./reports/wb_dma/icc_wb_dma_top_constraints.rpt
report_area > ./reports/wb_dma/icc_wb_dma_top_area.rpt
report_power > ./reports/wb_dma/icc_wb_dma_top_power.rpt
report_qor  > ./reports/wb_dma/icc_wb_dma_top_qor.rpt
report_cell > ./reports/wb_dma/icc_wb_dma_top_cells.rpt
report_resources > ./reports/wb_dma/icc_wb_dma_top_resources.rpt
report_timing -max_paths 10 > ./reports/wb_dma/icc_wb_dma_top_timing.rpt

save_mw_cel -as wb_dma_top_extracted
quit
