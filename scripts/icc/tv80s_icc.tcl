# Auto-generated ICC2 script for tv80s
# Configuration: tv80
...
set design_data ./outputs/tv80/tv80s.ddc
set cell_name "tv80s"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/tv80/$lib_name.mw \
...
open_mw_lib ./outputs/tv80/$lib_name.mw
read_verilog ./outputs/tv80/tv80s.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/tv80/tv80s.sdc
...
write_parasitics -output ./outputs/tv80s_extracted.spef -format SPEF
write_sdf ./outputs/tv80s_extracted.sdf
write_sdc ./outputs/tv80s_extracted.sdc
write_verilog ./outputs/tv80s_extracted.v

report_constraints -all > ./reports/tv80/icc_tv80s_constraints.rpt
report_area > ./reports/tv80/icc_tv80s_area.rpt
report_power > ./reports/tv80/icc_tv80s_power.rpt
report_qor  > ./reports/tv80/icc_tv80s_qor.rpt
report_cell > ./reports/tv80/icc_tv80s_cells.rpt
report_resources > ./reports/tv80/icc_tv80s_resources.rpt
report_timing -max_paths 10 > ./reports/tv80/icc_tv80s_timing.rpt

save_mw_cel -as tv80s_extracted
quit
