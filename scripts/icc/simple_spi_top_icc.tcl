# Auto-generated ICC2 script for simple_spi_top
# Configuration: simple_spi
...
set lib_name "simple_spi_top"
set mw_logic0_net VSS
set mw_logic1_net VDD
set design_data ./outputs/simple_spi/simple_spi_top.ddc
set cell_name "simple_spi_top"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/simple_spi/$lib_name.mw \
...
open_mw_lib ./outputs/simple_spi/$lib_name.mw
read_verilog ./outputs/simple_spi/simple_spi_top.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/simple_spi/simple_spi_top.sdc
...
write_parasitics -output ./outputs/simple_spi_top_extracted.spef -format SPEF
write_sdf ./outputs/simple_spi_top_extracted.sdf
write_sdc ./outputs/simple_spi_top_extracted.sdc
write_verilog ./outputs/simple_spi_top_extracted.v

report_constraints -all > ./reports/simple_spi/icc_simple_spi_top_constraints.rpt
report_area > ./reports/simple_spi/icc_simple_spi_top_area.rpt
report_power > ./reports/simple_spi/icc_simple_spi_top_power.rpt
report_qor  > ./reports/simple_spi/icc_simple_spi_top_qor.rpt
report_cell > ./reports/simple_spi/icc_simple_spi_top_cells.rpt
report_resources > ./reports/simple_spi/icc_simple_spi_top_resources.rpt
report_timing -max_paths 10 > ./reports/simple_spi/icc_simple_spi_top_timing.rpt

save_mw_cel -as simple_spi_top_extracted
quit
