# Auto-generated ICC2 script for pcm_slv_top
# Configuration: ss_pcm
...
set lib_name "pcm_slv_top"
set mw_logic0_net VSS
set mw_logic1_net VDD
set design_data ./outputs/ss_pcm/pcm_slv_top.ddc
set cell_name "pcm_slv_top"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/ss_pcm/$lib_name.mw \
...
open_mw_lib ./outputs/ss_pcm/$lib_name.mw
read_verilog ./outputs/ss_pcm/pcm_slv_top.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/ss_pcm/pcm_slv_top.sdc
...
write_parasitics -output ./outputs/pcm_slv_top_extracted.spef -format SPEF
write_sdf ./outputs/pcm_slv_top_extracted.sdf
write_sdc ./outputs/pcm_slv_top_extracted.sdc
write_verilog ./outputs/pcm_slv_top_extracted.v

report_constraints -all > ./reports/ss_pcm/icc_pcm_slv_top_constraints.rpt
report_area > ./reports/ss_pcm/icc_pcm_slv_top_area.rpt
report_power > ./reports/ss_pcm/icc_pcm_slv_top_power.rpt
report_qor  > ./reports/ss_pcm/icc_pcm_slv_top_qor.rpt
report_cell > ./reports/ss_pcm/icc_pcm_slv_top_cells.rpt
report_resources > ./reports/ss_pcm/icc_pcm_slv_top_resources.rpt
report_timing -max_paths 10 > ./reports/ss_pcm/icc_pcm_slv_top_timing.rpt

save_mw_cel -as pcm_slv_top_extracted
quit
