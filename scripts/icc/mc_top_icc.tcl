# Auto-generated ICC2 script for mc_top
# Configuration: mem_ctrl
...
set design_data ./outputs/mem_ctrl/mc_top.ddc
set cell_name "mc_top"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/mem_ctrl/$lib_name.mw \
...
open_mw_lib ./outputs/mem_ctrl/$lib_name.mw
read_verilog ./outputs/mem_ctrl/mc_top.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/mem_ctrl/mc_top.sdc
...
write_parasitics -output ./outputs/mc_top_extracted.spef -format SPEF
write_sdf ./outputs/mc_top_extracted.sdf
write_sdc ./outputs/mc_top_extracted.sdc
write_verilog ./outputs/mc_top_extracted.v

report_constraints -all > ./reports/mem_ctrl/icc_mc_top_constraints.rpt
report_area > ./reports/mem_ctrl/icc_mc_top_area.rpt
report_power > ./reports/mem_ctrl/icc_mc_top_power.rpt
report_qor  > ./reports/mem_ctrl/icc_mc_top_qor.rpt
report_cell > ./reports/mem_ctrl/icc_mc_top_cells.rpt
report_resources > ./reports/mem_ctrl/icc_mc_top_resources.rpt
report_timing -max_paths 10 > ./reports/mem_ctrl/icc_mc_top_timing.rpt

save_mw_cel -as mc_top_extracted
quit
