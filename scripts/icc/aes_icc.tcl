# Auto-generated ICC2 script for aes
# Configuration: systemcaes
...
set design_data ./outputs/systemcaes/aes.ddc
set cell_name "aes"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/systemcaes/$lib_name.mw \
...
open_mw_lib ./outputs/systemcaes/$lib_name.mw
read_verilog ./outputs/systemcaes/aes.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/systemcaes/aes.sdc
...
write_parasitics -output ./outputs/aes_extracted.spef -format SPEF
write_sdf ./outputs/aes_extracted.sdf
write_sdc ./outputs/aes_extracted.sdc
write_verilog ./outputs/aes_extracted.v

report_constraints -all > ./reports/systemcaes/icc_aes_constraints.rpt
report_area > ./reports/systemcaes/icc_aes_area.rpt
report_power > ./reports/systemcaes/icc_aes_power.rpt
report_qor  > ./reports/systemcaes/icc_aes_qor.rpt
report_cell > ./reports/systemcaes/icc_aes_cells.rpt
report_resources > ./reports/systemcaes/icc_aes_resources.rpt
report_timing -max_paths 10 > ./reports/systemcaes/icc_aes_timing.rpt

save_mw_cel -as aes_extracted
quit
