# Auto-generated ICC2 script for eth_top
...
set lib_name "eth_top"
set mw_logic0_net VSS
set mw_logic1_net VDD
set design_data ./outputs/ethernet/eth_top.ddc
set cell_name "eth_top"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/ethernet/$lib_name.mw \
...
open_mw_lib ./outputs/ethernet/$lib_name.mw
read_verilog ./outputs/ethernet/eth_top.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/ethernet/eth_top.sdc
...
write_parasitics -output ./outputs/eth_top_extracted.spef -format SPEF
write_sdf ./outputs/eth_top_extracted.sdf
write_sdc ./outputs/eth_top_extracted.sdc
write_verilog ./outputs/eth_top_extracted.v

report_constraints -all > ./reports/ethernet/icc_eth_top_constraints.rpt
report_area > ./reports/ethernet/icc_eth_top_area.rpt
report_power > ./reports/ethernet/icc_eth_top_power.rpt
report_qor  > ./reports/ethernet/icc_eth_top_qor.rpt
...
report_port > ./reports/ethernet/icc_eth_top_ports.rpt
sizeof_collection [get_ports [all_inputs]] >> ./reports/ethernet/icc_eth_top_ports.rpt
sizeof_collection [get_ports [all_outputs]] >> ./reports/ethernet/icc_eth_top_ports.rpt
# can also generate histograms
report_clock_tree -summary > ./reports/ethernet/icc_eth_top_clock_tree.rpt
sizeof_collection [get_cells -filter "ref_name=~*INV*" -clock_tree] >> ./reports/ethernet/icc_eth_top_clock_tree.rpt
