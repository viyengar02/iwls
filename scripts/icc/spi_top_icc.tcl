# Auto-generated ICC2 script for spi_top
# Configuration: spi
...
set lib_name "spi_top"
set mw_logic0_net VSS
set mw_logic1_net VDD
set design_data ./outputs/spi/spi_top.ddc
set cell_name "spi_top"
import_designs $design_data -format ddc -top $cell_name

create_mw_lib ./outputs/spi/$lib_name.mw \
...
open_mw_lib ./outputs/spi/$lib_name.mw
read_verilog ./outputs/spi/spi_top.v
uniquify_fp_mw_cel
link
read_sdc ./outputs/spi/spi_top.sdc
...
write_parasitics -output ./outputs/spi_top_extracted.spef -format SPEF
write_sdf ./outputs/spi_top_extracted.sdf
write_sdc ./outputs/spi_top_extracted.sdc
write_verilog ./outputs/spi_top_extracted.v

report_constraints -all > ./reports/spi/icc_spi_top_constraints.rpt
report_area > ./reports/spi/icc_spi_top_area.rpt
report_power > ./reports/spi/icc_spi_top_power.rpt
report_qor  > ./reports/spi/icc_spi_top_qor.rpt
report_cell > ./reports/spi/icc_spi_top_cells.rpt
report_resources > ./reports/spi/icc_spi_top_resources.rpt
report_timing -max_paths 10 > ./reports/spi/icc_spi_top_timing.rpt

save_mw_cel -as spi_top_extracted
quit
